...
- An array of all bookmarks

#### `GET /api/bookmark?username=USERNAME` - Get bookmarks by username

**Returns**

- An array of freets bookmarked by user with username `username`
...
- `freetId` _{string}_ - The freet to bookmark
...
#### `GET /api/like?username=USERNAME` - Get likes by username

**Returns**

- An array of freets liked by user with username `username`
...
#### `POST /api/like` - Create a new like

**Body**

- `freetId` _{string}_ - The freet to like
...
- An integer corresponding to the number of users who have liked a given freet
